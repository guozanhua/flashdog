...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			global:		{ range: '*', href: 'assets/style.css', containers: '60em', grid: { gutters: ['2em', 0] } },
			wide:		{ range: '-1680', href: 'assets/style-wide.css' },
			normal:		{ range: '-1280', href: 'assets/style-normal.css', viewport: { scalable: false } },
			narrow:		{ range: '-980', href: 'assets/style-narrow.css', containers: '90%' },
			narrower:	{ range: '-840', href: 'assets/style-narrower.css', containers: '90%!', grid: { zoom: 2 } },
			mobile:		{ range: '-736', href: 'assets/style-mobile.css', containers: '100%!' },
			mobilep:	{ range: '-480', href: 'assets/style-mobilep.css', grid: { zoom: 3 } }
		},
		plugins: {
			layers: {
